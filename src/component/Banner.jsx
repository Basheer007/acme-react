...
const Banner = () => {
  return (
    <>
      <section className="gradient-banner h-dvh" id="donate">
        {/* container */}
        <div className="max-w-5xl mx-auto  h-full grid content-center justify-end gap-3 px-4">
          <h1 className="text-white text-right font-sens text-2xl font-bold mb-2 tiny:text-4xl sm:text-5xl lg:text-5xl">
